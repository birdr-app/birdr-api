...
from .models import (Answer, ChallengeLevel, Country, CountryChallenge,
                         ...
                         Update, CountryGame)
from .utils import (get_country_images, get_images, get_media_citation,
...
class CountrySpeciesInline(admin.TabularInline):
    ...
    def link(self, obj):
        url = reverse('admin:_species_change', args=((obj.species_id,)))
...
class CountryAdmin(admin.ModelAdmin):
    ...
    def sync_species(self, request, pk=None):
        ...
        country_url = reverse('admin:_country_change', args=(country.pk,))
...
class SpeciesAdmin(admin.ModelAdmin):
    ...
    def get_media(self, request, pk=None):
        ...
        species_url = reverse('admin:_species_change', args=(species.pk,))
...
class PlayerScoreAdmin(admin.ModelAdmin):
    ...
    def order_score(self, obj):
        ...
        html = render_to_string('/order_score.html', context)
